...
#define BUTTON_CASE_1 34
#define BUTTON_CASE_2 35
#define I2S_LRC       25
#define I2S_BCLK      26
#define I2S_DIN       12
#define I2S_VOL       20
...
void setup()
{
    Serial.begin(115200);
    pinMode(2, OUTPUT);
    pinMode(BUTTON_CASE_1, INPUT);
    pinMode(BUTTON_CASE_2, INPUT);
...
{
    fnCheckMQTTConnect();
    if (digitalRead(BUTTON_CASE_1) == HIGH) {
        tone(27,2048,100,0);
        digitalWrite(2, HIGH);
    ...
    else if (digitalRead(BUTTON_CASE_2) == HIGH) {
        tone(27,2048,100,0);
        digitalWrite(2, HIGH);
